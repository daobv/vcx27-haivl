(function(f,a,c,g,e){
    ...
    function d(i){
        i.html('<div class="plupload_wrapper">\n\
<div class="ui-widget-content plupload_container">\n\
<div class="plupload"><div class="ui-state-default ui-widget-header plupload_header">\n\
<div class="plupload_header_content">\n\
<div class="plupload_header_title">'+b("Select files")+'</div>\n\
<div class="plupload_header_text">'+b("Add files to the upload queue and click the start button.")+'</div></div></div><div class="plupload_content">\n\
<table class="plupload_filelist"><tr class="ui-widget-header plupload_filelist_header">\n\
<td class="plupload_cell plupload_file_name">'+b("Filename")+'</td><td class="plupload_cell plupload_file_status">'+b("Status")+'</td>\n\
<td class="plupload_cell plupload_file_size">'+b("Size")+'</td><td class="plupload_cell plupload_file_action">&nbsp;</td></tr>\n\
</table><div class="plupload_scroll"><table class="plupload_filelist_content"></table></div><table class="plupload_filelist">\n\
<tr class="ui-widget-header ui-widget-content plupload_filelist_footer"><td class="plupload_cell plupload_file_name"><div class="plupload_buttons">\n\
<!-- Visible --><a class="plupload_button plupload_add">'+b("Add Files")+'</a>&nbsp;\n\
<a class="plupload_button plupload_start">'+b("Start Upload")+'</a>&nbsp;\n\
<a class="plupload_button plupload_stop plupload_hidden">'+b("Stop Upload")+'</a>&nbsp;</div><div class="plupload_started plupload_hidden">\n\
<!-- Hidden --><div class="plupload_progress plupload_right"><div class="plupload_progress_container"></div></div>\n\
<div class="plupload_cell plupload_upload_status"></div><div class="plupload_clearer">&nbsp;</div></div></td><td class="plupload_file_status">\n\
<span class="plupload_total_status">0%</span></td><td class="plupload_file_size">\n\
<span class="plupload_total_file_size">0 kb</span></td><td class="plupload_file_action"></td></tr></table></div></div></div>\n\
<input class="plupload_count" value="0" type="hidden"></div>')
    }
