    ...
    <div id="content-left" class="pull-left">
        <div id="kenh1" class="full-width pull-left">
            <div class="wrapper-title">
                ...
                <div class="title-content pull-left"><?php echo CHtml::link('KÊNH 1',array('kenh/kenh-1')); ?></div>
        ...
        <div id="kenh2" class="full-width pull-left">
            ...
            <div class="wrapper-title">
                ...
                <div class="title-content pull-left"><?php echo CHtml::link('KÊNH 2',array('kenh/kenh-2')); ?></div>
        ...
        <div id="kenh3" class="full-width pull-left">
            <div class="wrapper-title">
                <div class="title-left pull-left"></div>
                <div class="title-content pull-left"><?php echo CHtml::link('KÊNH 3',array('kenh/kenh-3')); ?></div>
                <div class="title-right pull-left"></div>
            </div>
        ...
        <div id="kenh4" class="full-width pull-left">
            <div class="wrapper-title">
                <div class="title-left pull-left"></div>
                <div class="title-content pull-left"><?php echo CHtml::link('KÊNH 4',array('kenh/kenh-4')); ?></div>
                <div class="title-right pull-left"></div>
            </div>
